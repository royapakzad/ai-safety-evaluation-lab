                        ...
                        <div className="flex items-center gap-3 mt-2">
                            ...
                            <div className="flex-grow">
                                {llmItem.total > 0 ? (
                                    <>
                                        <div className="w-full flex h-5 rounded-md overflow-hidden bg-muted">
                                            <button className="bg-destructive/80 hover:bg-destructive transition-colors" style={{ width: `${llmYesPercent}%` }} title={`Yes: ${llmItem.yes}`} onClick={() => onBarClick(d.label, 'yes', 'llm')}></button>
